...
#[derive(Debug)]
pub struct UltraBioProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraBioProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraBio processing");
    
    let mut processor = UltraBioProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraBioProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraBioProcessor::new(false);
